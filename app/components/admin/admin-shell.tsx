...
/** Sidebar entries. `soon` marks sections whose screens are not built yet. */
const navSections: {
  href: string;
  label: string;
  ...
  { href: "/admin/images", label: "Hero / Website Images", icon: icon("M4 4h16a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1Zm1 13h14l-4.5-6-3.5 4.5-2.5-3L5 17Z"), soon: true },
  { href: "/admin/contact", label: "Contact Information", icon: icon("M6.6 10.8c1.4 2.8 3.8 5.2 6.6 6.6l2.2-2.2c.3-.3.7-.4 1-.2 1.1.4 2.3.6 3.6.6.6 0 1 .4 1 1V20c0 .6-.4 1-1 1C10.9 21 3 13.1 3 3.5 3 3 3.4 2.5 4 2.5h3.4c.6 0 1 .4 1 1 0 1.3.2 2.5.6 3.6.1.4 0 .8-.2 1L6.6 10.8Z"), soon: true },
  { href: "/admin/join-applications", label: "Join Applications", icon: icon("M6 2h9l5 5v15a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1Zm8 1.5V8h4.5L14 3.5ZM8 12h8v2H8v-2Zm0 4h8v2H8v-2Z"), soon: true },
  { href: "/admin/events", label: "Events Management", icon: icon("M7 2v2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-2V2h-2v2H9V2H7ZM5 9h14v11H5V9Z"), soon: true },
  { href: "/admin/news", label: "News Management", icon: icon("M4 4h13a1 1 0 0 1 1 1v13a2 2 0 0 0 2 2H5a2 2 0 0 1-2-2V5a1 1 0 0 1 1-1Zm2 4v3h9V8H6Zm0 5v2h9v-2H6Z"), soon: true },
  { href: "/admin/gallery", label: "Gallery", icon: icon("M3 6h4l2-2h6l2 2h4a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1Zm9 3a5 5 0 1 0 5 5 5 5 0 0 0-5-5Z"), soon: true },
  { href: "/admin/content", label: "Website Content", icon: icon("M4 3h16a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1Zm2 4v2h12V7H6Zm0 4v2h12v-2H6Zm0 4v2h8v-2H6Z"), soon: true },
  { href: "/admin/profile", label: "Admin Profile", icon: icon("M12 12a5 5 0 1 0-5-5 5 5 0 0 0 5 5Zm0 2c-4 0-8 2-8 5v3h16v-3c0-3-4-5-8-5Z"), soon: true },
  { href: "/admin/settings", label: "Settings", icon: icon("M12 8a4 4 0 1 0 4 4 4 4 0 0 0-4-4Zm9.4 4a7.6 7.6 0 0 0-.1-1.2l2-1.6-2-3.4-2.4 1a7.5 7.5 0 0 0-2-1.2L16.5 3h-4l-.4 2.6a7.5 7.5 0 0 0-2 1.2l-2.4-1-2 3.4 2 1.6a7.6 7.6 0 0 0 0 2.4l-2 1.6 2 3.4 2.4-1a7.5 7.5 0 0 0 2 1.2l.4 2.6h4l.4-2.6a7.5 7.5 0 0 0 2-1.2l2.4 1 2-3.4-2-1.6c.1-.4.1-.8.1-1.2Z"), soon: true },
];
            ...
            {navSections.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {item.soon && (
                    <span className="rounded-full border border-admin-border px-1.5 py-0.5 text-[10px] uppercase tracking-wide text-admin-muted">
                      Soon
                    </span>
                  )}
                </Link>
